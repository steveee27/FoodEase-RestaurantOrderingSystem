...
export declare namespace HttpApiGroup {
     ...
     * @category models
     */
    type Context<Group> = Group extends HttpApiGroup<infer _Name, infer _Endpoints, infer _Error, infer _R, infer _TopLevel> ? HttpApiMiddleware.HttpApiMiddleware.Only<_R> : never;
    /**
     * @since 1.0.0
     * @category models
     */
