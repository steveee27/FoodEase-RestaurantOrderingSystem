...
export declare const toFile: {
    ...
    }) | undefined): <Message>(self: Logger.Logger<Message, string>) => Effect<Logger.Logger<Message, void>, PlatformError, Scope | FileSystem>;
    /**
     * Create a Logger from another string Logger that writes to the specified file.
     *
     * @since 1.0.0
     ...
     * )
     */
    <Message>(self: Logger.Logger<Message, string>, path: string, options?: (OpenFileOptions & {
        readonly batchWindow?: DurationInput | undefined;
    }) | undefined): Effect<Logger.Logger<Message, void>, PlatformError, Scope | FileSystem>;
};
//# sourceMappingURL=PlatformLogger.d.ts.map