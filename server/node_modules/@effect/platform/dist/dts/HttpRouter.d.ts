...
export declare const mountApp: {
    ...
    <R1, E1>(path: `/${string}`, that: App.Default<E1, R1>, options?: {
        readonly includePrefix?: boolean | undefined;
    } | undefined): <E, R>(self: HttpRouter<E, R>) => HttpRouter<E1 | E, HttpRouter.ExcludeProvided<R1> | HttpRouter.ExcludeProvided<R>>;
    /**
     * @since 1.0.0
     * @category routing
     */
    <E, R, E1, R1>(self: HttpRouter<E, R>, path: `/${string}`, that: App.Default<E1, R1>, options?: {
        readonly includePrefix?: boolean | undefined;
    } | undefined): HttpRouter<E | E1, HttpRouter.ExcludeProvided<R> | HttpRouter.ExcludeProvided<R1>>;
};
/**
 * @since 1.0.0
 * @category routing
...
export declare const route: (method: Method.HttpMethod | "*") => {
    <R1, E1>(path: PathInput, handler: Route.Handler<E1, R1>, options?: {
        readonly uninterruptible?: boolean | undefined;
    } | undefined): <E, R>(self: HttpRouter<E, R>) => HttpRouter<E1 | E, R | Exclude<R1, ServerRequest.HttpServerRequest | RouteContext | Scope.Scope>>;
    <E, R, E1, R1>(self: HttpRouter<E, R>, path: PathInput, handler: Route.Handler<E1, R1>, options?: {
        readonly uninterruptible?: boolean | undefined;
    } | undefined): HttpRouter<E | E1, R | Exclude<R1, ServerRequest.HttpServerRequest | RouteContext | Scope.Scope>>;
};
/**
 * @since 1.0.0
 * @category routing
...
export declare const use: {
     ...
     * @category combinators
     */
    <E, R, R1, E1>(self: HttpRouter<E, R>, f: (self: Route.Middleware<E, R>) => App.Default<E1, R1>): HttpRouter<E1, HttpRouter.ExcludeProvided<R1>>;
};
/**
 * @since 1.0.0
 * @category combinators
...
export declare const transform: {
     ...
     * @category combinators
     */
    <E, R, R1, E1>(f: (self: Route.Handler<E, R>) => App.HttpApp<Respondable.Respondable, E1, R1>): (self: HttpRouter<E, R>) => HttpRouter<E1, HttpRouter.ExcludeProvided<R1>>;
    /**
     * @since 1.0.0
     * @category combinators
     */
    <E, R, R1, E1>(self: HttpRouter<E, R>, f: (self: Route.Handler<E, R>) => App.HttpApp<Respondable.Respondable, E1, R1>): HttpRouter<E1, HttpRouter.ExcludeProvided<R1>>;
};
/**
 * @since 1.0.0
 * @category combinators
...
export declare const catchTag: {
    ...
    <K extends E extends {
        _tag: string;
    } ? E["_tag"] : never, E, E1, R1>(k: K, f: (e: Extract<E, {
        _tag: K;
    }>) => Route.Handler<E1, R1>): <R>(self: HttpRouter<E, R>) => HttpRouter<E1 | Exclude<E, {
        _tag: K;
     ...
     * @category combinators
     */
    <E, R, K extends E extends {
        _tag: string;
    } ? E["_tag"] : never, E1, R1>(self: HttpRouter<E, R>, k: K, f: (e: Extract<E, {
        _tag: K;
    }>) => Route.Handler<E1, R1>): HttpRouter<E1 | Exclude<E, {
        _tag: K;
    }>, R | HttpRouter.ExcludeProvided<R1>>;
};
/**
...
export declare const catchTags: {
    ...
    } : {}>(cases: Cases): <R>(self: HttpRouter<E, R>) => HttpRouter<Exclude<E, {
        _tag: keyof Cases;
    }> | {
        [K in keyof Cases]: Cases[K] extends (...args: Array<any>) => Effect.Effect<any, infer E, any> ? E : never;
    }[keyof Cases], R | HttpRouter.ExcludeProvided<{
    ...
    } : {}>(self: HttpRouter<E, R>, cases: Cases): HttpRouter<Exclude<E, {
        _tag: keyof Cases;
    }> | {
        [K in keyof Cases]: Cases[K] extends (...args: Array<any>) => Effect.Effect<any, infer E, any> ? E : never;
    }[keyof Cases], R | HttpRouter.ExcludeProvided<{
...
export declare const provideServiceEffect: {
     ...
     * @category combinators
     */
    <T extends Context.Tag<any, any>, R1, E1>(tag: T, effect: Effect.Effect<Context.Tag.Service<T>, E1, R1>): <E, R>(self: HttpRouter<E, R>) => HttpRouter<E1 | E, Exclude<R, Context.Tag.Identifier<T>> | Exclude<HttpRouter.ExcludeProvided<R1>, Context.Tag.Identifier<T>>>;
    /**
     * @since 1.0.0
     * @category combinators
     */
    <E, R, T extends Context.Tag<any, any>, R1, E1>(self: HttpRouter<E, R>, tag: T, effect: Effect.Effect<Context.Tag.Service<T>, E1, R1>): HttpRouter<E | E1, Exclude<R, Context.Tag.Identifier<T>> | Exclude<HttpRouter.ExcludeProvided<R1>, Context.Tag.Identifier<T>>>;
};
/**
 * @since 1.0.0
 * @category tags
 ...
 * @category tags
 */
export declare class Default extends Default_base {
}
export {};
